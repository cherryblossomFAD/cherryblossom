...
var CherryBlossom = React.createClass ({
  ...
  render: function() {
    ...
    <TabBarIOS
        ...
        <TabBarIOS.Item
          ...
          {this._renderContent('Destinations')}
        </TabBarIOS.Item>
        <TabBarIOS.Item
          systemIcon="history"
          ...
          {this._renderContent('History', this.state.notifCount)}
        </TabBarIOS.Item>
        <TabBarIOS.Item
          systemIcon="more"
          ...
          {this._renderContent('More', this.state.presses)}
        </TabBarIOS.Item>
      </TabBarIOS>
    );
  }
